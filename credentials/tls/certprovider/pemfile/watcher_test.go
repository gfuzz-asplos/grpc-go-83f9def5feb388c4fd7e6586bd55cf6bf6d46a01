...
func TestProvider_NoUpdate(t *testing.T) {
...
func TestProvider_UpdateSuccess(t *testing.T) {
...
func TestProvider_UpdateSuccessWithSymlink(t *testing.T) {
	// Override the newDistributor to one which pushes on a channel that we
	// can block on.
	origDistributorFunc := newDistributor
	distCh := testutils.NewChannel()
...
// material is updated.
func TestProvider_UpdateFailure_ThenSuccess(t *testing.T) {
