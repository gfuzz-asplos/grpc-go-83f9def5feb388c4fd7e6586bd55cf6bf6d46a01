...
func TestClientOptionsConfigErrorCases(t *testing.T) {
	tests := []struct {
		desc            string
...
func TestClientOptionsConfigSuccessCases(t *testing.T) {
	tests := []struct {
		desc            string
		clientVType     VerificationType
		IdentityOptions IdentityCertificateOptions
...
func TestServerOptionsConfigErrorCases(t *testing.T) {
	tests := []struct {
		desc              string
...
func TestServerOptionsConfigSuccessCases(t *testing.T) {
	tests := []struct {
		desc              string
		requireClientCert bool
		serverVType       VerificationType
