...
func TestResolverBuilder_xdsCredsBootstrapMismatch(t *testing.T) {
...
func TestXDSResolverCloseClosesXDSClient(t *testing.T) {
	xdsC := fakeclient.NewClient()
...
func TestXDSResolverRequestHash(t *testing.T) {
...
func TestXDSResolverRemovedWithRPCs(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
// removed.
func TestXDSResolverRemovedResource(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
func TestXDSResolverWRR(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
func TestXDSResolverMaxStreamDuration(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
func TestXDSResolverDelayedOnCommitted(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
func TestXDSResolverMultipleLDSUpdates(t *testing.T) {
	xdsC := fakeclient.NewClient()
	xdsR, tcc, cancel := testSetup(t, setupOpts{
		xdsClientFunc: func() (xdsclient.XDSClient, error) { return xdsC, nil },
	})
...
func TestXDSResolverHTTPFilters(t *testing.T) {
	var path []string
	testCases := []struct {
		name         string
