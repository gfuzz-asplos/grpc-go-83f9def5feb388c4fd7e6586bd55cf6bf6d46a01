...
func TestBalancerGroup_InitOneSubBalancerTransientFailure(t *testing.T) {
	cc, gator, bg := newTestBalancerGroup(t, nil)
...
func TestBalancerGroup_SubBalancerTurnsConnectingFromTransientFailure(t *testing.T) {
	cc, gator, bg := newTestBalancerGroup(t, nil)
...
func TestBalancerGroup_CloseStopsBalancerInCache(t *testing.T) {
...
func TestBalancerGroupBuildOptions(t *testing.T) {
	const (
