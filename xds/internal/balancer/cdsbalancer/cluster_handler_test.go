...
func TestSuccessCaseLeafNode(t *testing.T) {
	tests := []struct {
		name          string
		clusterName   string
...
func TestSuccessCaseLeafNodeThenNewUpdate(t *testing.T) {
	tests := []struct {
		name             string
		clusterName      string
		clusterUpdate    xdsclient.ClusterUpdate
...
func TestUpdateRootClusterAggregateSuccess(t *testing.T) {
	ch, fakeClient := setupTests(t)
...
func TestUpdateRootClusterAggregateThenChangeChild(t *testing.T) {
...
// cluster of type EDS.
func TestUpdateRootClusterAggregateThenChangeRootToEDS(t *testing.T) {
	// This initial code is the same as the test for the aggregate success case,
	// except without validations. This will get this test to the point where it
...
func TestHandleRespInvokedWithError(t *testing.T) {
	ch, fakeClient := setupTests(t)
...
func TestSwitchClusterNodeBetweenLeafAndAggregated(t *testing.T) {
