...
// underlying grpc.Server.
func TestServeWithStop(t *testing.T) {
	fs, clientCh, cleanup := setupOverrides()
	defer cleanup()
...
func TestServeBootstrapFailure(t *testing.T) {
...
func TestServeBootstrapConfigInvalid(t *testing.T) {
	tests := []struct {
		desc            string
...
func TestServeNewClientFailure(t *testing.T) {
	origNewXDSClient := newXDSClient
	newXDSClient = func() (xdsclient.XDSClient, error) {
...
func TestHandleListenerUpdate_NoXDSCreds(t *testing.T) {
	fs, clientCh, cleanup := setupOverrides()
	defer cleanup()
...
func TestHandleListenerUpdate_ErrorUpdate(t *testing.T) {
