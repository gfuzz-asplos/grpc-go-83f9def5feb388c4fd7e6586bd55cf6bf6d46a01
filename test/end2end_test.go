...
func TestDetailedConnectionCloseErrorPropagatesToRpcError(t *testing.T) {
...
func TestDetailedGoawayErrorOnGracefulClosePropagatesToRPCError(t *testing.T) {
	rpcDoneOnClient := make(chan struct{})
	ss := &stubserver.StubServer{
		FullDuplexCallF: func(stream testpb.TestService_FullDuplexCallServer) error {
			<-rpcDoneOnClient
...
func TestDetailedGoawayErrorOnAbruptClosePropagatesToRPCError(t *testing.T) {
...
func TestPreloaderSenderSend(t *testing.T) {
	ss := &stubserver.StubServer{
		FullDuplexCallF: func(stream testpb.TestService_FullDuplexCallServer) error {
			for i := 0; i < 10; i++ {
				preparedMsg := &grpc.PreparedMsg{}
...
func TestMetadataOrderUnaryRPC(t *testing.T) {
	for _, e := range listTestEnv() {
...
func TestClientInitialHeaderEndStream(t *testing.T) {
	for _, e := range listTestEnv() {
		if e.httpHandler {
			continue
		}
...
func TestClientSendDataAfterCloseSend(t *testing.T) {
	for _, e := range listTestEnv() {
		if e.httpHandler {
			continue
		}
...
func TestForceCodecName(t *testing.T) {
...
func TestForceServerCodec(t *testing.T) {
	ss := &stubserver.StubServer{
		EmptyCallF: func(ctx context.Context, in *testpb.Empty) (*testpb.Empty, error) {
			return &testpb.Empty{}, nil
		},
...
// code in this case.
func TestMalformedStreamMethod(t *testing.T) {
...
func TestHTTPHeaderFrameErrorHandlingHTTPMode(t *testing.T) {
...
func TestHTTPHeaderFrameErrorHandlingInitialHeader(t *testing.T) {
...
func TestHTTPHeaderFrameErrorHandlingMoreThanTwoHeaders(t *testing.T) {
	header := []string{
		":status", "200",
		"content-type", "application/grpc",
	}
...
func TestClientCancellationPropagatesUnary(t *testing.T) {
	wg := &sync.WaitGroup{}
...
func TestGzipBadChecksum(t *testing.T) {
	ss := &stubserver.StubServer{
...
func TestCanceledRPCCallOptionRace(t *testing.T) {
	ss := &stubserver.StubServer{
		FullDuplexCallF: func(stream testpb.TestService_FullDuplexCallServer) error {
...
func TestClientSettingsFloodCloseConn(t *testing.T) {
...
func TestDeadlineSetOnConnectionOnClientCredentialHandshake(t *testing.T) {
	lis, err := net.Listen("tcp", "localhost:0")
	if err != nil {
		t.Fatalf("Failed to listen: %v", err)
	}
